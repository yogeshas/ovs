...
<th>Status</th>
 ...
 $q = "select * from loginusers ";

 $query = mysqli_query($con,$q);

 while($res = mysqli_fetch_array($query)){
$image = (!empty($res['profile'])) ? '../'.$res['profile'] : '../image/nolive.jpg';
$image1 = (!empty($res['livephoto'])) ? '../'.$res['livephoto'] : '../image/nolive.jpg';
 ?>
...
<td> <?php 
 echo  "<img src='".$image1."' width='100px' height='100px'>" ?></td>
 <td> <?php echo $res['status'];  ?> </td>


<td> <button class="btn-danger btn"> <a href="vdelete.php?firstname=<?php echo $res['firstname']; ?>" class="text-white"> Delete </a>  </button> 
  <button class="btn-primary btn"> <a href="confirm.php?firstname=<?php echo $res['firstname']; ?>" class="text-white"> Confirm </a> </button> </td>
