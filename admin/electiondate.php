...
<!-- Sidebar -->
<div class="w3-sidebar w3-red w3-bar-block" style="width:20%; margin-top: -10px; ">
...
<div class="w3-container" style="margin-top: 10px" >
 <h1 style="text-align: center;">Election Date List</h1>
<div class="w3-container">
 

                    <button onclick="document.getElementById('id01').style.display='block'" style="background-color: white;height: 50px;width: 200px;cursor: pointer;margin-left: -90px;"  >ADD ELECTION DATES<i class="fa fa-plus" style="margin-left: 10px;"></i> </button>  
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <form class="w3-container" action="electionadd.php" method="post"  enctype="multipart/form-data">
        <div class="w3-section">
          <div class="w3-pale-green w3-center" style="margin-top: 40px;">
          <h1>Add Election Date</h1>
        </div>
        <br><br><br>
          ...
          <select  name="area" >
            ...
            <option value="mainleader" disabled="">MAIN LEADER</option>
...
<div class="w3-container w3-cell" style="margin-top: 50px; margin-left: -100px; " >
  ...
  <input  type="text" placeholder="Search for id.." class="w3-input w3-border w3-padding w3-cell" id="myInput" onkeyup="myFunction()" style="width: 1140px;margin-left: -90px;">
...
<td>
  <button class="btn-primary btn" > <a href="eupdate.php?id=<?php echo $res['id']; ?>" class="text-white" style="text-decoration: none;color: white;"> Update </a> </button> 
   <button class="btn-primary btn" > <a href="edelete.php?id=<?php echo $res['id']; ?>" class="text-white" style="text-decoration: none;color: white;"> delete </a> </button> 
